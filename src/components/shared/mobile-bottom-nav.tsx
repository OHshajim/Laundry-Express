        ...
        {NAV_ITEMS.map((item) => {
          ...
          if (item.isPrimary) {
            return (
              ...
              >
                <div className="h-12 w-12 rounded-full bg-gradient-to-r from-sky-500 to-blue-600 flex items-center justify-center text-white shadow-lg shadow-sky-500/40 group-active:scale-95 transition-all">
                  <Icon className="h-5 w-5 animate-pulse" />
                </div>
                <span className="text-[10px] font-bold text-sky-700 mt-0.5">
                  {item.name}
                </span>
